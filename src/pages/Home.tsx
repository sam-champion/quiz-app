...
function Home() {
  ...
  return (
    <div className="h-screen bg-custom-gradient flex flex-col items-center text-white">
      ...
      <div className="flex flex-col items-center space-y-6 max-w-screen-md w-full text-center flex-grow justify-center px-4 sm:px-8">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-6 mt-8 w-full">
          ...
          <button
            ...
            className="flex items-center justify-center min-w-60 space-x-2 px-6 py-4 bg-gradient-to-b from-pink-500 to-rose-600 text-white rounded-xl shadow-lg hover:shadow-2xl hover:scale-105 transform transition duration-300 sm:w-auto"
          >
